<?php
class TrustindexPlugin_wordpressPlugin
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Wordpress Reviews", "do-not-care-Wordpress Plugin");
