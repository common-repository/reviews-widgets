...
$pluginManager = 'TrustindexPlugin_wordpressPlugin';
$pluginManagerInstance = $trustindex_pm_wordpressPlugin;
$pluginNameForEmails = 'Wordpress Plugin';
$newBadgeTabs = [];
...
$logoCampaignId = 'wp-wordpressPlugin-l';
...
$assetCheckCssId = 'trustindex_settings_style_wordpressPlugin';
