...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'Wordpress Plugin'),
...
<h1 class="ti-header-title"><?php echo sprintf(__('Connect %s', 'trustindex-plugin'), 'Wordpress Plugin'); ?></h1>
...
<?php else: ?>
<div class="ti-box">
<form method="post" action="" data-platform="wordpressPlugin" id="ti-connect-platform-form">
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'Wordpress Plugin');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "Wordpress Plugin");
$placeholder = __('e.g.:', 'trustindex-plugin') . ' ' . esc_attr($exampleUrl);




$labelText = sprintf(__('Your plugin URL on %s', 'trustindex-plugin'), "Wordpress Plugin");
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'Wordpress reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'Wordpress Plugin'); ?>
</p>
</div>
<?php endif; ?>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-wordpressPlugin-1';
$tiCampaign2 = 'wp-wordpressPlugin-2';
